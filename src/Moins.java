...
public class Moins extends NonTerminalExpression{

    // Constructor
    public Moins(String exp,ArrayList<Expression> expressions, NonTerminalExpression next) {
    ...
    public double Evaluer() {
        ...
        if(done){
            ...
            setNext(new Multiplication(this.getExp(),new ArrayList<>(),null));
